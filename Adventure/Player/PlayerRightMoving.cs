...
public class PlayerRightMoving : PlayerMoving
{
    private void Update()
    {
        adventureManager.ScoreUpdate((int)(totalDistance + transform.position.x - previousPosValue));
    }
    ...
    {
        totalDistance += transform.position.x - previousPosValue;
    }
}
